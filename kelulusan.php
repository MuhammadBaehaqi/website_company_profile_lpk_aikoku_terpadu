...
<body>
    ...
    <div class="gallery">
        <div class="gallery-item">
            <img src="img/lulus.jpg" alt="Gallery Image 1">
        </div>
        <div class="gallery-item">
            <img src="img/lulus.jpg" alt="Gallery Image 2">
        </div>
        <div class="gallery-item">
            <img src="img/lulus.jpg" alt="Gallery Image 3">
        </div>
        <div class="gallery-item">
            <img src="img/lulus.jpg" alt="Gallery Image 4">
        </div>
        <div class="gallery-item">
            <img src="img/lulus.jpg" alt="Gallery Image 5">
        </div>
        <div class="gallery-item">
            <img src="img/lulus.jpg" alt="Gallery Image 6">
        </div>
    </div>
