        ...
        <div class="team-grid"> <!--  berisi daftar anggota tim pengurus lembaga, dengan setiap anggota ditempatkan dalam tag -->
            ...
            <div class="team-member">
                ...
                <div class="member-info">
                    <h3>Nama Wakil Direktur</h3>
                    <div class="position">Wakil Direktur</div>
                    <div class="description">
            ...
            <div class="team-member">
                ...
                <div class="member-info">
                    <h3>Nama Kabag Pelatihan</h3>
                    <div class="position">Kepala Bagian Pelatihan</div>
                    <div class="description">
                        Mengembangkan dan mengawasi program pelatihan untuk memastikan kualitas tertinggi.
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="legal-documents">
            <div class="legal-item">
                ...
                <h3>Nomor Izin Pengiriman Pemagangan</h3>
