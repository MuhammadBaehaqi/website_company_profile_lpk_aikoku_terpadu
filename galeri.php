...
<body>
 ...
 <?php include('navbar.php'); ?>
                ...
                <div class="nav-buttons">
                    ...
                    <a href="fasilitas.html" class="nav-button">Fasilitas LPK</a>
                    <a href="pendidikan.html" class="nav-button">Pendidikan LPK</a>
                    <a href="album.html" class="nav-button">Album LPK</a>
                </div>
